...
def runProposeAlgorithms():
    ...
    calculateMetrics("Propose BiLSTM Algorithm", predict, target)
...
def graph():
    df = pd.DataFrame([['BiLSTM','Precision',precision[0]],['BiLSTM','Recall',recall[0]],['BiLSTM','F1 Score',fscore[0]],['BiLSTM','Accuracy',accuracy[0]],
...
proposeButton = Button(main, text="Run Propose DL-BILSTM Algorithm", command=runProposeAlgorithms)
